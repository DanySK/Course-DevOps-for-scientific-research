...
\begin{frame}[fragile,allowframebreaks]{My first Gradle build}
    \begin{block}{Takeaways}
        ...
        \end{itemize}
    \end{block}
    \groovy{02-SimpleTask}{build.gradle.kts}{\normalsize}
...
\begin{frame}[fragile,allowframebreaks]{Build scripts are code}
    \begin{block}{Takeaways}
        ...
        \end{itemize}
    \end{block}
    \groovy{03-BuildAsCode}{build.gradle.kts}{\normalsize}
...
\begin{frame}[fragile,allowframebreaks]{Task dependencies}
    \begin{block}{Takeaways}
        ...
        \end{itemize}
    \end{block}
    \groovy{04-TaskDependencies}{build.gradle.kts}{\scriptsize}
...
\begin{frame}[fragile,allowframebreaks]{Dynamic tasks}
    \begin{block}{Takeaways}
        ...
        \end{itemize}
    \end{block}
    \groovy{05-DynamicTasks}{build.gradle.kts}{\scriptsize}
