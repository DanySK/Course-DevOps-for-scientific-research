...
\begin{frame}[fragile,allowframebreaks]{Adding properties to tasks}
    \begin{block}{Takeaways}
        \begin{itemize}
...
\begin{frame}[fragile,allowframebreaks]{Configuring default tasks}
    \begin{block}{Takeaways}
        \begin{itemize}
...
\begin{frame}[fragile,allowframebreaks]{Java project with dependencies}
    \java{01-dependencies}{src/main/java/it/unibo/ci/PrintBreakingBad.java}{\tiny}
    \groovy{01-dependencies}{build.gradle}{\normalsize}
    \groovy{01-dependencies}{gradle.properties}{\scriptsize}
    \groovy{01-dependencies}{settings.gradle}{\normalsize}
    \begin{block}{Takeaways}
        \begin{itemize}
...
\begin{frame}[fragile, allowframebreaks]{Generating Ivy and Maven compatible metadata in Gradle}
    ...
    \begin{itemize}
        ...
        \item It provides an uploadArchives task for preparing a Maven-compatible distribution
        \begin{itemize}
            \item Including a valid POM descriptor
        \end{itemize}
    \groovy{23-POM}{gradle.properties}{\scriptsize}
    \groovy{23-POM}{settings.gradle}{\normalsize}
...
Generating Ivy metadata (pom.xml)

\begin{frame}[fragile]{Packaging with Python setuptools}
% https://github.com/simoninireland/simplicial/blob/master/setup.py.in
